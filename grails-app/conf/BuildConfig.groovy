...
grails.project.dependency.resolution = {
    ...
    dependencies {
		...
		runtime 'org.springframework:spring-test:4.2.0.RELEASE'
        // runtime 'org.postgresql:postgresql:9.3-1101-jdbc41'
        runtime 'org.json:json:20160810'
        test "org.grails:grails-datastore-test-support:1.0.2-grails-2.4"

        //runtime "ApiKtbs:ApiKtbs:1.0"
    ...
    plugins {
        ...
        build ":tomcat:8.0.20" // or ":tomcat:8.0.22"
        ...
        compile "org.grails.plugins:browser-detection:2.9.0"
