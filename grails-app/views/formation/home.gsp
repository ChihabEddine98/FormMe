...
<body>
    ...
    <div class="mainPane" id="main">
        <div class="coursDispo">
            ...
            <!-- Tab content -->
            <div class="container">
            <% def coursDispo =track.Cours.findAll() %>
                <g:each class="${(i % 2) == 0 ? 'even' : 'odd'}" var="cours" in="${coursDispo.sort({ a, b-> a.id.compareTo(b.id)} )}" status="i" >

                    <g:if test = "${i==0}" >
                        <input id="${"radDispo"+(i+1).toString()}" type="radio" name="radDispo" checked>
                    </g:if>


                    <g:else>
                        <input id="${"radDispo"+(i+1).toString()}" type="radio" name="radDispo">
                    </g:else>
...
%{--                        <asset:image class="userImg" src="${cours.imgUrl}" alt="cours"/>--}%
                        ...
                        <div class="seq-btn">
                            <g:if test = "${i==0}" >
                                <label for="${"radDispo"+(coursDispo.size()).toString()}"><i class="fa fa-chevron-left"></i></label>
                                <label for="${"radDispo"+(i+2).toString()}"><i class="fa fa-chevron-right"></i></label>
                            </g:if>
                            <g:elseif test="${i==coursDispo.size()-1}">
                                <label for="${"radDispo"+(i).toString()}"><i class="fa fa-chevron-left"></i></label>
                                <label for="${"radDispo"+(1).toString()}"><i class="fa fa-chevron-right"></i></label>
                            </g:elseif>
                            <g:else>
                                <label for="${"radDispo"+(i).toString()}"><i class="fa fa-chevron-left"></i></label>
                                <label for="${"radDispo"+(i+2).toString()}"><i class="fa fa-chevron-right"></i></label>
